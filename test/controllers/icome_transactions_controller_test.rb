...
class IcomeTransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create icome_transaction" do
    assert_difference("IcomeTransaction.count") do
      post icome_transactions_url, params: { icome_transaction: { amount: @icome_transaction.amount, name: @icome_transaction.name, user_id: @icome_transaction.user_id } }
    end
  ...
  test "should update icome_transaction" do
    patch icome_transaction_url(@icome_transaction), params: { icome_transaction: { amount: @icome_transaction.amount, name: @icome_transaction.name, user_id: @icome_transaction.user_id } }
